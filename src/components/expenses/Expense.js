...
const Expense = () => {
    ...
    const getExpenseData = () => {
        axios.get(
            'https://expense-tracker-5b2f1-default-rtdb.firebaseio.com/expense.json'
            ).then((res) => {
                const data = res.data;
                let sumOfExpenses = 0;
    ...
    const addExpenseHandler = async(event) => {
        ...
        try {
            const res = await axios.post('https://expense-tracker-5b2f1-default-rtdb.firebaseio.com/expense.json',
            expenseObj );
            console.log(res);
            getExpenseData();
        } catch (err) {
    ...
    const deleteExpenseHandler = (expenseId) => {
        axios.delete(
            `https://expense-tracker-5b2f1-default-rtdb.firebaseio.com/expense/${expenseId}.json`
        ).then((res) => {
            console.log(res);
            getExpenseData();
        }).catch((err) => {
